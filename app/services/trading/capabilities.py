    ...
    "buff": PlatformCapability(
        ...
        capabilities={
            ...
            CAP_DIRECT_BUY: CapabilitySpec(
                CAP_DIRECT_BUY,
                STATUS_READY,
                "buff.buyer.BuffBuyer.direct_buy",
                required_credentials=("buff.cookies",),
                request_ids=("goods_id", "sell_order_id", "price", "num"),
                response_ids=("order_id", "bill_order_id", "sell_order_id"),
            ),
    ...
    "uuyp": PlatformCapability(
        ...
        capabilities={
            ...
            CAP_DIRECT_BUY: CapabilitySpec(
                ...
                notes="UUYP PC web does not expose direct-buy execution; Steamauto covers PC list/query and purchase orders, not direct listing purchase.",
            ),
            CAP_PURCHASE_ORDER: CapabilitySpec(
                CAP_PURCHASE_ORDER,
                STATUS_READY,
