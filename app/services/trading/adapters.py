...
RESULT_OFFER_EXPIRED = "offer_expired"
RESULT_OFFER_DECLINED = "offer_declined"
RESULT_MOBILE_CONFIRM_REQUIRED = "mobile_confirm_required"
...
def normalize_platform_result(
    ...
    *,
    ...
    if not success:
        ...
        elif reason in {"not_found", "listing_not_found", "sell_order_not_found", "order_not_found"} or "not found" in text or "missing" in text:
