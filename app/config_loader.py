...
def get_buff_credentials() -> dict:
    return get_buff()
def update_steam_creds(cookies: str, session_id: str, steam_id: str = None, trade_link: str = None) -> None:
    update_steam_credentials(cookies, session_id, steam_id=steam_id, trade_link=trade_link)
